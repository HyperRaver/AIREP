"""
Google Trends Backfill — NEGATIVE Sentiment (Solo Anchor + Pointwise)
=====================================================================
Anchor: "sell bitcoin"
...
print("NEGATIVE SENTIMENT GROUP (solo anchor + pointwise method)")
...
output_file = os.path.join(OUTPUT_DIR, "google_trends_negative.csv")
